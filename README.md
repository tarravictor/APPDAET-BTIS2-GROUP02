...
A shared kanban board (TO DO / IN PROGRESS / IN REVIEW / DONE) for the BTIS2 Group 2 project. It runs as a static site on GitHub Pages and stores all issues in a free Supabase database, so every member sees the same live board.
